...
SOURCE_FILES = Sched_Data.cc Sched_SolutionManager.cc Sched_SwapHours_NHE.cc Sched_AssignProf_NHE.cc Sched_CostComponents.cc  Sched_Main.cc
OBJECT_FILES = Sched_Data.o Sched_SolutionManager.o Sched_SwapHours_NHE.o Sched_AssignProf_NHE.o Sched_CostComponents.o Sched_Main.o
...
Sched_AssignProf_NHE.o: Sched_AssignProf_NHE.cc $(HEADER_FILES)
	g++ -c $(COMPOPTS) Sched_AssignProf_NHE.cc
